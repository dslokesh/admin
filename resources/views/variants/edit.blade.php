        ...
        <div class="col-md-12">
          ...
          <option value="Interhotel" @if($record->entry_type == 'Interhotel') {{'selected="selected"'}} @endif >Interhotel</option>
			  ...
			  <div class="form-group col-md-4 transfer_plan_div">
			   ...
			   <div class="form-group col-md-6 transfer_plan_div">
			...
			<div class="form-group col-md-6 zones_div" id="zones_div">
			  ...
			  @if(!empty($record->image))
                <div class="col-md-2">
                  <img src="{{asset('uploads/variants/thumb/'.$record->image)}}" style="width:100px; height:100px;margin-top:-6px" class="cimage" />
                </div>
				@endif
