			...
			<a class="btn btn-danger btn-sm float-right remove-btn" href="javascript:void(0)">Remove Block <i class="fas fa-trash"></i></a>
				...
				<input type="hidden" id="u_code{{$rowCount}}"  name="u_code[]"  class="form-control"  value="{{$activity->id.'-'.$rowCount.time()}}" />
              </div>
			  <div class="form-group col-md-3">
			  ...
			  <div class="form-group col-md-3">
                ...
                <input type="text" id="slot_duration{{$rowCount}}" name="slot_duration[]" value="{{ old('slot_duration') }}" class="form-control"  placeholder="Slot Duration"  />
			  ...
			  <div class="form-group col-md-3">
                ...
                <input type="text" id="rate_valid_from{{$rowCount}}" name="rate_valid_from[]"  class="form-control"  placeholder="Rate Valid From (yyyy-mm-dd)"  required="required"  autocomplete="off" readonly />
			  ...
			  <div class="form-group col-md-3">
                ...
                <input type="text" id="rate_valid_to{{$rowCount}}" name="rate_valid_to[]" class="form-control"  placeholder="Rate Valid To (yyyy-mm-dd)"  required="required" autocomplete="off" readonly />
                ...
                <input type="text" id="pickup_time{{$rowCount}}" name="pickup_time[]" value="{{ old('pickup_time') }}" class="form-control "  placeholder="Pickup Time"  />
                ...
                <input type="text" id="drop_time{{$rowCount}}" name="drop_time[]" value="{{ old('drop_time') }}" class="form-control "  placeholder="Drop Time"  />
