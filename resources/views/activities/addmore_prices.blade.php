			...
			<a class="btn btn-danger btn-sm float-right remove-btn" href="javascript:void(0)">Remove Block <i class="fas fa-trash"></i></a>
			  ...
			  <div class="form-group col-md-3">
                ...
                <input type="text" id="rate_valid_from{{$rowCount}}" name="rate_valid_from[]"  class="form-control datepicker"  placeholder="Rate Valid From (yyyy-mm-dd)"  required  />
			  ...
			  <div class="form-group col-md-3">
                ...
                <input type="text" id="rate_valid_to{{$rowCount}}" name="rate_valid_to[]" class="form-control datepicker"  placeholder="Rate Valid To (yyyy-mm-dd)"  required  />
