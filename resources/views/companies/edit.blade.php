...
@section('content')
    ...
    <form action="{{ route('companies.update', $company->id) }}" method="post" class="form">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') ?: $company->name }}" class="form-control"  placeholder="Name" />
                @if ($errors->has('name'))
