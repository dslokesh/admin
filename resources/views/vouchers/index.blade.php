...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
          ...
          <th><input type="text" name="invcode" value="{{request('invcode')}}" autocomplete="off" class="form-control"  placeholder="Invoice No" /></th>
          ...
          <td>{{ ($record->invoice_number)}}</td>
					...
					<td>{{  SiteHelpers::getVoucherTotalPrice($record->id);}}</td>
					 <td>
