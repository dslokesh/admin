          ...
          <div class="card card-primary">
            ...
            <div class="card-body row">
			  ...
			  <div class="form-group col-md-6">
			   ...
			   <div class="form-group col-md-6 flight_is_div" style="display:none">
                <label for="inputName">Airline: <span class="red">*</span></label>
                <select name="airlines_id" id="airlines_id" class="form-control">
				<option value="">--select--</option>
                   @foreach($airlines as $airline)
                    <option value="{{$airline->id}}" @if(old('airlines_id') == $airline->id) {{'selected="selected"'}} @endif>{{$airline->name}}</option>
				@endforeach
                 </select>
			   ...
			   <div class="form-group col-md-3 flight_is_div" style="display:none">
