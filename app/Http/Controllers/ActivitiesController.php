...
class ActivitiesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('activities.create',compact('typeActivities','countries','currencies'));
    }
    ...
    public function edit($id)
    {
		...
		return view('activities.edit',compact('record','typeActivities','countries','states','cities','images', 'image_key','currencies'));
    }
